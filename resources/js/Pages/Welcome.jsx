                                                    ...
                                                    <div className="text-4xl flex justify-between w-full">
                                                        ...
                                                        <div>
                                                            <Link
                                                                ...
                                                                className=" underline rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                                            >
                                                                Continue
                                                            </Link>
                                                        </div>
                                            ...
                                            >
                                                ...
                                                <div className="pt-3 sm:pt-5 lg:pt-0">
                                                    ...
                                                    <p className="mt-4 text-sm/relaxed">
                                                        ...
                                                        are a newcomer or have
                                                        prior experience with
                                                        Laravel, we recommend
                                                        reading our
                                                        documentation from
                                                        beginning to end.
                                                    </p>
